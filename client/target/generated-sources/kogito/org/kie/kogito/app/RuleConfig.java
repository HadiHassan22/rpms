...
class RuleConfig extends AbstractRuleConfig {
    ...
    public RuleConfig(List<RuleEventListenerConfig> ruleEventListenerConfigs, List<AgendaEventListener> agendaEventListeners, List<RuleRuntimeEventListener> ruleRuntimeEventListeners) {
